...
public class P2ptargetController {
	...
	public static Map<String, Object> deploy(/*HttpServletRequest request*/) {
		String address = "";
		try {
			BigInteger totalAmount = new BigInteger("5"/*request.getParameter("totalAmount")*/);
	...
	public static Map<String, Object>  getTotalAmount(/*HttpServletRequest request*/) throws Exception{
		String address = "0xff3d3e19c7251fafd7807f821430239048202067";//request.getParameter("contractAddress");
	...
	public static Map<String, Object> buyTicket(/*HttpServletRequest request*/) throws InterruptedException, ExecutionException {
		String to = "0xff3d3e19c7251fafd7807f821430239048202067";//request.getParameter("contractAddress");
		P2ptarget contract = P2ptarget.load(to, web3j, getCredentials(1), new BigInteger("60000"), new BigInteger("900000"));
		System.out.println(contract.totalAmount().get().getValue().toString());
		BigInteger totalAmount = contract.totalAmount().get().getValue();
		BigInteger value = new BigInteger("4"/*request.getParameter("value")*/);//new BigInteger(values);
		BigInteger unit = new BigInteger("1000000000000000000");
		value = value.multiply(unit);
		Map<String, Object> map = new HashMap<>();
		if(totalAmount.compareTo(value)>0){
			String bidderAddress = "0x882f967839a9984ca20569d703900aa180b9b548";//出价者  "0xeb97bed0631515013f58b066b8e8561694e06a3b";
	        Address buyer = new Address("0x35554633b352f94253289189e3e73052de3fcd26"/*request.getParameter("buyer")*/);
